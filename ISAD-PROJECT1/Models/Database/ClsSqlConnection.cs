...
namespace ISAD_PROJECT1.Models.DBConnection
{
    public class ClsSqlConnection
    {
        ...
        private void getConnection()
        {
            try
            {
                string constr = "Server=DESKTOP-FQ90H1P\\SQLEXPRESS;Database=E12024;User Id=sodaSQL;Password=sodaIT@168;TrustServerCertificate=True";
